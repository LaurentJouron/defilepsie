...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\dateutil\__init__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.dateutil.__init__.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.dateutil.__init__.source.html#l12">
                  <tt><i>12</i> <span class="k">def</span> <span class="fm">__getattr__</span><span class="p">(</span><span class="n">name</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
