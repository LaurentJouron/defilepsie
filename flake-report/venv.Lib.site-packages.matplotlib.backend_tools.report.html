...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\matplotlib\backend_tools.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.matplotlib.backend_tools.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.matplotlib.backend_tools.source.html#l38">
                  <tt><i>38</i> <span class="n">cursors</span> <span class="o">=</span> <span class="n">Cursors</span>  <span class="c1"># Backcompat.</span></tt>
               </a>
            </li>
            </ul>
         </li>
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.matplotlib.backend_tools.source.html#l126">
                  <tt><i>126</i>         <span class="c1"># The setter must explicitly call self.set_figure so that subclasses can</span></tt>
               </a>
            </li>
            </ul>
         </li>
