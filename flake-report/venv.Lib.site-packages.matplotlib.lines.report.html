...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\matplotlib\lines.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.matplotlib.lines.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.matplotlib.lines.source.html#l1481">
                  <tt><i>1481</i> <span class="sd">            Both *xy2* and *slope* must be passed, but one of them must be None.</span></tt>
               </a>
            </li><li>
               
               <p>Line too long (84 > 79 characters):</p>
               
               <a href="venv.Lib.site-packages.matplotlib.lines.source.html#l1483">
                  <tt><i>1483</i> <span class="sd">            The slope of the line. Both *xy2* and *slope* must be passed, but one of</span></tt>
               </a>
            </li>
            </ul>
         </li>
