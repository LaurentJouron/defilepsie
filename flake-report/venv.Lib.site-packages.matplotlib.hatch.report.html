...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\matplotlib\hatch.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.matplotlib.hatch.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.matplotlib.hatch.source.html#l170">
                  <tt><i>170</i> <span class="n">_hatch_types</span> <span class="o">=</span> <span class="p">[</span></tt>
               </a>
            </li>
            </ul>
         </li>
