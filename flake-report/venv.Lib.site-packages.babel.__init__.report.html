...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\babel\__init__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.babel.__init__.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.babel.__init__.source.html#l11">
                  <tt><i>11</i> <span class="sd">     * a Python interface to the CLDR (Common Locale Data Repository), providing</span></tt>
               </a>
            </li>
            </ul>
         </li>
