...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\fontTools\ttLib\standardGlyphOrder.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.fontTools.ttLib.standardGlyphOrder.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.fontTools.ttLib.standardGlyphOrder.source.html#l5">
                  <tt><i>5</i> <span class="c1"># My list is correct according to the Apple documentation for the &#39;post&#39;  table:</span></tt>
               </a>
            </li>
            </ul>
         </li>
