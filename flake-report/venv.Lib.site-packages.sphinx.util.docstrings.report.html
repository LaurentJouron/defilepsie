...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\sphinx\util\docstrings.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.sphinx.util.docstrings.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.sphinx.util.docstrings.source.html#l46">
                  <tt><i>46</i> <span class="sd">    Return the docstring as a list of lines usable for inserting into a docutils</span></tt>
               </a>
            </li>
            </ul>
         </li>
