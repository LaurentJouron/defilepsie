...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\idna\package_data.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.idna.package_data.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.idna.package_data.source.html#l2">
                  <tt><i>2</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
