...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\matplotlib\colorbar.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.matplotlib.colorbar.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.matplotlib.colorbar.source.html#l1383">
                  <tt><i>1383</i> <span class="sd">    parents : `~matplotlib.axes.Axes` or iterable or `numpy.ndarray` of `~.axes.Axes`</span></tt>
               </a>
            </li>
            </ul>
         </li>
