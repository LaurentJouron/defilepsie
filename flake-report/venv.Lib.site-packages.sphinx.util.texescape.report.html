...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\sphinx\util\texescape.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.sphinx.util.texescape.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.sphinx.util.texescape.source.html#l34">
                  <tt><i>34</i>     <span class="c1"># Greek alphabet not escaped: pdflatex handles it via textalpha and inputenc</span></tt>
               </a>
            </li>
            </ul>
         </li>
