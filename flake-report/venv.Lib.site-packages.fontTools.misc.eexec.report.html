...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\fontTools\misc\eexec.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.fontTools.misc.eexec.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.fontTools.misc.eexec.source.html#l65">
                  <tt><i>65</i> <span class="sd">    Note that the algorithm as described in the Type 1 specification requires the</span></tt>
               </a>
            </li>
            </ul>
         </li>
