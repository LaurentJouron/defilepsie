...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\fontTools\misc\macCreatorType.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.fontTools.misc.macCreatorType.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.fontTools.misc.macCreatorType.source.html#l22">
                  <tt><i>22</i> <span class="sd">            A tuple of two :py:class:`fontTools.textTools.Tag` objects, the first</span></tt>
               </a>
            </li>
            </ul>
         </li>
